...
public class StudentDashboardActivity extends AppCompatActivity {
    private com.example.smart_attend.databinding.ActivityStudentDashboardBinding binding;
    private com.example.smart_attend.ui.adapters.SubjectAdapter adapter;
    private com.example.smart_attend.utils.SessionManager sessionManager;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        binding = com.example.smart_attend.databinding.ActivityStudentDashboardBinding.inflate(getLayoutInflater());
